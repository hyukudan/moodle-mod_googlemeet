...
$string['ai_noanalysis'] = 'No AI analysis available yet. Click "Generate AI Analysis" to create one.';
...
$string['ai_generated_on'] = 'Generated on {$a}';
$string['ai_model_used'] = 'Model: {$a}';
$string['ai_copy_transcript'] = 'Copy transcript';
